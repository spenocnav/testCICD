# ==============================================================================
# extract_def.py — Extrae lecturas del nivel de fluido DEF (AdBlue/urea)
#
# Diagnostic ID: DiagnosticDieselExhaustFluidId  (INMUTABLE)
# Chunk: 3 días
...
SCRIPT_ID     = 'consumo_def'
DIAGNOSTIC_ID = DIAGNOSTIC_IDS['def']   # 'DiagnosticDieselExhaustFluidId'  INMUTABLE
...
def main():
    run_status_extraction(
        ...
        chunk_days=CHUNK_SIZE_DAYS['consumo_def'],
